...
animate();
        ...
        // Dynamique : Étapes et barre de progression
        const currentStep = 2; // Change cette valeur (1 à 4) pour simuler l'état
        const steps = document.querySelectorAll('.step');
        const progressBarFill = document.getElementById('progress-bar-fill');

        // Remplit la barre en fonction de l'étape
        progressBarFill.style.width = `${(currentStep - 1) / (steps.length - 1) * 100}%`;
