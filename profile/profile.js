...
function toggleEdit(fieldId) {
    ...
    if (inputField.disabled) {
        ...
        // Désactiver le champ après modification
        inputField.disabled = true;
        button.textContent = "Modifier";

        // Afficher les nouvelles valeurs dans la console (ou envoyer au serveur)
        console.log(`Champ ${fieldId} mis à jour : ${inputField.value}`);
    }
}
